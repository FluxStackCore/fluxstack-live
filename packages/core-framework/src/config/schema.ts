// Default config is in defaults/index.ts
import { defaultFluxStackConfig as defaultConfig } from './defaults'

export const defaultFluxStackConfig = defaultConfig

export const environmentDefaults = defaultConfig.environments ?? {
  development: {},
  production: {},
  test: {}
}
